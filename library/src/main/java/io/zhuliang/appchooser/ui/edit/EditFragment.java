package io.zhuliang.appchooser.ui.edit;
...
public class EditFragment extends ResolveInfosFragment {
    ...
    public static EditFragment newInstance(ActionConfig actionConfig) {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        Preconditions.checkNotNull(actionConfig.uri);
        if (actionConfig.mimeType == null) {
            actionConfig.mimeType = MimeType.ALL;
        }
    ...
    private void loadResolveInfos() {
        ...
        intent.setDataAndType(mActionConfig.uri, mActionConfig.mimeType);
