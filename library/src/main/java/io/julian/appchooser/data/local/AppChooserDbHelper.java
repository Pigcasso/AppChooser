...
import io.julian.appchooser.data.local.AppChooserPersistenceContract.ActivityInfoEntity;

import static io.julian.appchooser.data.local.AppChooserPersistenceContract.COMMA_SEP;
import static io.julian.appchooser.data.local.AppChooserPersistenceContract.TEXT_TYPE;
